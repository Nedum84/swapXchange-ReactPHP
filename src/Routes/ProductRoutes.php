...
final class ProductRoutes{
    ...
    private function _route() {
        ...
        //search/
        $this->routes->get('/search/{query}/{offset}/{limit}[/{filters}]', new \App\Controller\Products\FindAll($this->dbCon));
        $this->routes->get('/category/{category_id}', new \App\Controller\Products\FindAll($this->dbCon));
        $this->routes->get('/subcategory/{subcategory_id}', new \App\Controller\Products\FindAll($this->dbCon));
